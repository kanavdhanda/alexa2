...
const WALL_T = 0.14;
const WALL_COLOR = '#D5C6E5';  // beautiful soft lavender/purple matching the reference image
const POST_COLOR = '#C2B2D2';  // matching slightly darker post lavender
...
function CornerPost({ x, z, height, activeRoomId, adjacentRooms }: PostProps) {
  ...
  return (
    <mesh position={[x, height / 2, z]} castShadow raycast={() => null}>
